...
# define SWORD 64                              /* Word size in bits */
# define MASK 0xffffffffffffffff               /* Mask of sword bits */
# define G1BYTE(p,q,b) ((b==64 ? MASK : ~(MASK<<b)) & (p>>(SWORD-(q+b))))
                                               /* Get 1 word contained byte */
# define MASK1(q,b) (b==64 ? MASK : (~(MASK<<b)<<(SWORD-(q+b))))
                                               /* Mask of sword bits */
